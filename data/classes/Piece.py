...
class Piece:
    ...
    # gets all the available moves of the current player, including attacking the enemy piece. 
    # If an opponent piece is in range of a piece's move, 
    # the piece can capture it where its range will limit on these opponent's piece tile position through 
    # output.append(square) then break unless the piece is Knight which can move in an 'L-shape'.
